...
set_secret "BREVO_API_KEY" "Enter Brevo API key (for auth/reminders/feedback emails)"
set_secret "RESEND_API_KEY" "Enter Resend API key (optional fallback provider)"

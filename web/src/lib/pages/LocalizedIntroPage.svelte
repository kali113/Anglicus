<script lang="ts">
  ...
  const highlights = $derived([
    {
      title: tx("intro.highlights.placement.title"),
      detail: tx("intro.highlights.placement.detail"),
    },
    {
      title: tx("intro.highlights.locale.title"),
      detail: tx("intro.highlights.locale.detail"),
    },
    {
      title: tx("intro.highlights.privacy.title"),
      detail: tx("intro.highlights.privacy.detail"),
    },
  ]);

  const steps = $derived([
    {
      title: tx("intro.steps.one.title"),
      body: tx("intro.steps.one.body"),
    },
    {
      title: tx("intro.steps.two.title"),
      body: tx("intro.steps.two.body"),
    },
    {
      title: tx("intro.steps.three.title"),
      body: tx("intro.steps.three.body"),
    },
  ]);

  const featureCards = $derived([
    {
      tag: tx("intro.cards.chat.tag"),
      title: tx("intro.cards.chat.title"),
      body: tx("intro.cards.chat.body"),
    },
    {
      tag: tx("intro.cards.path.tag"),
      title: tx("intro.cards.path.title"),
      body: tx("intro.cards.path.body"),
    },
    {
      tag: tx("intro.cards.speaking.tag"),
      title: tx("intro.cards.speaking.title"),
      body: tx("intro.cards.speaking.body"),
    },
  ]);
...
<section class="intro-shell" aria-labelledby="intro-title">
  ...
  <div class="intro-grid">
    <article class="panel hero-panel">
      <p class="badge">{tx("intro.badge")}</p>
      <h1 id="intro-title">{tx("intro.title")}</h1>
      <p class="subtitle">{tx("intro.subtitle")}</p>
    ...
    <aside class="panel journey-panel" id="how-it-works">
      ...
      <p class="journey-note">{tx("intro.journeyNote")}</p>
    </aside>
  </div>

  <section class="feature-grid" aria-label={tx("intro.featuresLabel")}>

<script lang="ts">
	...
	import { getCompletion, buildTutorSystemPrompt, buildUserContext } from '$lib/ai/index.js';
	...
	async function sendMessage() {
		...
		try {
			...
			const systemPrompt = buildTutorSystemPrompt(profile);
...
<div class="tutor-page">
	...
	<form class="input-form" onsubmit={(e) => { e.preventDefault(); sendMessage(); }}>
		...
		<button type="submit" disabled={!inputMessage.trim() || isLoading} class="send-btn">
			<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 11 2"/></svg>
		</button>
	</form>
</div>
